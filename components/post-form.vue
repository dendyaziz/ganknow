  ...
  <div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-4 ring-1 ring-slate-900/5 mb-4">
    <div class="flex flex-row">
      ...
      <div class="w-full">
        ...
        <div
          class="transition-height transition-spacing rounded-lg px-4 ring-1 ring-slate-200 text-slate-900 dark:text-white overflow-hidden"
          :class="{'h-[60px] ring-slate-200 dark:ring-slate-600 mt-4 py-3': menuVisible, 'h-0 ring-transparent': !menuVisible}"
        >
