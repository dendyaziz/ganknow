...
export default {
  async asyncData({ $axios }) {
    const response = await $axios.get('https://api-staging.gamepal.gg/v1/posts?author=18439b9e-3d73-437c-8e94-dddb41ab6271&perPage=20&page=1', {
      headers: {
