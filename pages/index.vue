<template>
  <div class="max-w-[680px] mx-auto">
    <!-- Alert -->
    <div class="bg-yellow-500/10 hover:bg-yellow-500/20 hover:cursor-pointer sm:rounded-lg pl-4 pr-6 py-4 mb-2 md:mb-4 ring-1 ring-yellow-500/70 flex flex-row items-start">
      <!-- Icon -->
      <img
      ...
      <div class="text-slate-900 dark:text-white">
        ...
        <!-- CTA -->
        <div class="flex mt-2 flex-row items-center font-bold">
          {{ $t('Enable now') }}
          <svg
            width="24"
            height="24"
